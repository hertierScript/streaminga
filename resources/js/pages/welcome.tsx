...
function MovieCard({ movie }: { movie: Movie }) {
    return (
        <Card className="mx-auto h-[420px] w-full max-w-[220px] overflow-hidden rounded-lg border-gray-700 bg-gray-800 transition-all hover:scale-105 hover:shadow-2xl sm:h-[460px] sm:max-w-[250px] md:h-[480px]">
            <Link href={`/movies/${movie.id}`}>
                <div className="relative aspect-[2/3] overflow-hidden bg-gray-700">
                    ...
                    <div className="absolute top-2 right-2 sm:top-3 sm:right-3">
                        <Badge className="flex items-center gap-1 bg-red-600 px-1.5 py-0.5 text-white shadow-lg hover:bg-red-700 sm:px-2 sm:py-1">
                    ...
                    <div className="absolute right-2 bottom-2 left-2 sm:right-3 sm:bottom-3 sm:left-3">
                        <Badge
                            variant="secondary"
                            className="w-fit border-0 bg-black/80 px-2 py-0.5 text-xs text-white capitalize sm:px-3 sm:py-1"
                        >
                            {movie.genre[0] || 'Movie'}
                        </Badge>
                    </div>
                </div>
                <CardContent className="flex h-[140px] flex-col justify-between p-4 sm:h-[160px] sm:p-5 md:h-[170px]">
                    <div>
                        <h3 className="mb-3 line-clamp-2 text-base leading-tight font-bold text-white sm:text-lg">
                            {movie.title}
                        </h3>
                        <div className="mb-2 flex items-center justify-between text-sm text-gray-400 sm:text-base">
